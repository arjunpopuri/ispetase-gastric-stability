# This script writes step1_pepsin_cleavage.py completely from scratch
...
with open("scripts/step1_pepsin_cleavage.py", "w") as f:
    f.write(code)

print("step1_pepsin_cleavage.py written successfully.")
